...
<div class="container">
  <div class="row row-produk">
    <div class="col-lg-5">
      <figure class="figure">
        <img src="<?php echo base_url('assets/images/home/cardmakeup.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 450px;">
        <figcaption class="figure-caption d-flex justify-content-evenly">
          <a href="#">
            <img src="<?php echo base_url('assets/images/pengantin/1.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
          <a href="#">
            <img src="<?php echo base_url('assets/images/pengantin/2.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
          <a href="#">
            <img src="<?php echo base_url('assets/images/pengantin/3.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
          <a href="#">
            <img src="<?php echo base_url('assets/images/pengantin/4.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
          <a href="#">
            <img src="<?php echo base_url('assets/images/pengantin/5.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
    ...
    <div class="col-lg-7">
      <h4>Make Up tanpa Dekorasi</h4>
      <div class="garis-nama"></div>
      <h3 class="text-muted mb-3">Rp 500.000</h3>
<!-- Description-->
<div class="row row-produk">
  <div class="col-12">
  <div class="card">
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      <p> Make Up tanpa dekorasi merupakan sebuah layanan make up yang melayani acara seperti Wisuda, Karnaval, Engangement, maupun acara lainnya. Pada layanan ini juga tersedia berbagai macam make up adat pengantin mulai dari adat Bali, Aceh, Jawa, dan daerah lainnya.
      Disini kami akan membantu anda untuk mewujudkan make up yang cantik untuk segala acara anda. Tunggu apalagi pesan sekarang!!
      </p>
      <footer class="blockquote-footer">MUA <cite title="Source Title"></cite></footer>
    </blockquote>
    <br>
    </div>
