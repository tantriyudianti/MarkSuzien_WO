...
<div class="container">
  ...
  <div class="container">
    <div class="row row-produk">
      <div class="col-lg-5">
        <figure class="figure">
          <img src="<?php echo base_url('assets/images/prasmanan/16.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 450px;">
          <figcaption class="figure-caption d-flex justify-content-evenly">
            <a href="#">
              <img src="<?php echo base_url('assets/images/prasmanan/17.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
            </a>
            <a href="#">
              <img src="<?php echo base_url('assets/images/prasmanan/18.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
            </a>
            <a href="#">
              <img src="<?php echo base_url('assets/images/prasmanan/19.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
            </a>
            <a href="#">
              <img src="<?php echo base_url('assets/images/prasmanan/20.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
            </a>
            <a href="#">
              <img src="<?php echo base_url('assets/images/prasmanan/16.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
            </a>
  ...
  <!-- Description-->
        ...
        <div class="col-12">
            ...
            <div class="card-body">
              <blockquote class="blockquote mb-0">
                <p> Catering untuk prasmanan ada banyak pilihan menu makanan dari mulai makanan berat hingga dessert. Berikut beberapa menu menu makanan yang tersedia bakso, mie, capjay, sate ayam, sate kambing, puding, dan masih banyak menu lainnya.
                </p>
                <footer class="blockquote-footer">Chef <cite title="Source Title"></cite></footer>
              </blockquote>
              <br>
                </div>
    ...
    <form id="payment-form" method="post" action="<?=site_url()?>/snapppp/finish">
