...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" src="<?php echo base_url('assets/bootstrap-4.4.1-dist/css/bootstrap.min.css');?>">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link" <?php echo anchor('user/logout', 'Log Out', 'attributes'); ?> </a>
        </li>
        </li>
        </li>
      </ul>
...
<div id="carouselExampleIndicators" class="carousel slide mt-5" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo base_url('assets/images/home/1.jpg');?>" class="d-block" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/images/home/2.jpg');?>" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/images/home/3.jpg');?>" class="d-block w-100" alt="...">
    </div>
  </div>
  ...
  <div class="row text-center row-container mt-2">
    <div class="col-lg-3 col-md-3 col-sm-4 col-6">
      <div class="menu-kategori">
        <a href="pemesanan.html"><img src="<?php echo base_url('assets/images/logo/l1.png');?>" class="img-servis mt-2"></a>
          <p>MAKE UP</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-4 col-6">
      <div class="menu-kategori">
        <a href="pemesanan1.html"><img src="<?php echo base_url('assets/images/logo/l2.png');?>" class="img-servis mt-2"></a>
          <p>DEKORASI</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-4 col-6">
      <div class="menu-kategori">
        <a href="pemesanan2.html"><img src="<?php echo base_url('assets/images/logo/l3.png');?>" class="img-servis mt-2"></a>
          <p>FOTOGRAFI</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-4 col-6">
      <div class="menu-kategori">
        <a href="pemesanan3.html"><img src="<?php echo base_url('assets/images/logo/l4.png');?>" class="img-servis mt-2"></a>
          <p>CATERING</p>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-lg2 col-md-3 col-sm-4 col-6">
      <div class="card" style="width: 17rem;">
       <img src="<?php echo base_url('assets/images/home/cardmakeup.jpg');?>" class="card-img-top" alt="...">
      <div class="card-body">
   ...
   <div class="col-lg2 col-md-3 col-sm-4 col-6">
      <div class="card" style="width: 17rem;">
       <img src="<?php echo base_url('assets/images/home/cardekorasi.jpg');?>" class="card-img-top" alt="...">
      <div class="card-body">
   ...
   <div class="col-lg2 col-md-3 col-sm-4 col-6">
      <div class="card" style="width: 17rem;">
       <img src="<?php echo base_url('assets/images/home/cardfoto.jpg');?>" class="card-img-top" alt="...">
      <div class="card-body">
   ...
   <div class="col-lg2 col-md-3 col-sm-4 col-6">
      <div class="card" style="width: 17rem;">
       <img src="<?php echo base_url('assets/images/home/cardkatering.jpg');?>" class="card-img-top" alt="...">
      <div class="card-body">
