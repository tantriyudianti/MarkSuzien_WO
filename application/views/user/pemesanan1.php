...
<div class="container">
  <div class="row row-produk">
    <div class="col-lg-5">
      <figure class="figure">
        <img src="<?php echo base_url('assets/images/pengantin/7.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 450px;">
        <figcaption class="figure-caption d-flex justify-content-evenly">
          <a href="#">
            <img src="<?php echo base_url('assets/images/pengantin/6.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
          <a href="#">
            <img src="<?php echo base_url('assets/images/pengantin/7.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
          <a href="#">
            <img src="<?php echo base_url('assets/images/dekorasi/8.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
          <a href="#">
            <img src="<?php echo base_url('assets/images/dekorasi/9.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
          <a href="#">
            <img src="<?php echo base_url('assets/images/dekorasi/10.jpg');?>" class="figure-img img-fluid" style="border-radius: 5px; width: 70px;">
          </a>
        </figcaption>
      </figure>
    </div>
    <div class="col-lg-7">
      <h4>Make Up dengan Dekorasi</h4>
      <div class="garis-nama"></div>
      <h3 class="text-muted mb-3">Rp 3.000.000</h3>
<!-- Description-->
<div class="row row-produk">
  <div class="col-12">
    <div class="row row-produk">
      ...
      <div class="card-body">
        <blockquote class="blockquote mb-0">
          <p> Mape Up dengan dekorasi menyediakan layanan make up pengantin sekaligus dekorasi. Dekorasi memiliki banyak pilihan meliputi indoor atau outdoor.
          Tunggu apalagi pesan sekarang!!
          </p>
    ...
    <form id="payment-form" method="post" action="<?=site_url()?>/snapp/finish">
